...
(function(){
  ...
  function addScorecardLogo(){
    ...
    const brand=document.createElement('div');brand.className='scorecard-atg-brand';brand.innerHTML='<img src="agape-golf-logo.png" alt="Agape Tumoutou Golfers"><div><b>AGAPE TUMOUTOU GOLFERS</b><small>Faith · Fellowship · Fairways</small></div>';
