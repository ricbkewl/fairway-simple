...
(function(){
  ...
  function geojson(){
    ...
    return{type:'FeatureCollection',properties:{name:draft?.name||'Golf Course',holes:draft?.holes||draft?.greens?.length||0,generated_by:'Agape Tumoutou Golfers',generated_at:new Date().toISOString(),license_note:'Only contribute factual data you personally verified or are legally permitted to share.'},features};
  }
