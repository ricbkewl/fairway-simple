/* ATG v186 — GPS-first search priority and three-color GPS indicator.
...
(function(){
  ...
  function gpsState(course){
    const audited=window.atgAuditedGpsState?.(course);
    if(audited){
  ...
  window.normalizeATGGpsIndicators=normalizeIndicators;
