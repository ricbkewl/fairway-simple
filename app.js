...
function initInlineHoleMap(green){
  ...
  inlinePlannerLines=[L.polyline([origin,aim],{color:'#f5cf68',weight:4,opacity:1}).addTo(inlineHoleMap),L.polyline(remainingPoints,{color:'#f5dfa8',weight:2.25,opacity:.95,dashArray:'7 9'}).addTo(inlineHoleMap)];
