...
function positionExpandedGuide(details){
  ...
  const update=details.querySelector('.guide-update');if(update)update.textContent='Current feature guide · Version 84 · Updated August 30, 2026';
