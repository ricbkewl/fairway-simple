...
function initInlineHoleMap(green){
  ...
  inlineHoleMap=L.map(container,{zoomControl:false,zoomSnap:.25,dragging:true,scrollWheelZoom:false,doubleClickZoom:true,boxZoom:false,keyboard:false,touchZoom:true,attributionControl:false});
